  ...
  return (
    <>
      <div
        ...
        className='mt-8 justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none'
      >
        <div className='pt-40 sm:pt-0 relative w-auto my-6  max-w-3xl m-6 '>
          {/*content*/}
          <div className='pt-40 sm:pt-0 border-0 rounded-lg shadow-lg relative top-32 flex flex-col w-full bg-white outline-none focus:outline-none'>
            {/*header*/}
